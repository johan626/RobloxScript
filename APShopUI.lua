...
function apShopUI:Create()
	...
	apLabel.Size = UDim2.new(0.5, -15, 1, 0)
	...
	apLabel.Position = UDim2.new(0.5, 0, 0, 0)
	...
	scrollingFrame.Size = UDim2.new(0.5, -5, 1, -45)
	...
	previewPanel.Size = UDim2.new(0.5, -5, 1, -45)
	previewPanel.Position = UDim2.new(0.5, 0, 0, 40)
	...
	for weaponName, weaponData in pairs(WeaponModule.Weapons) do
		for skinName, skinData in pairs(weaponData.Skins) do
			if skinData.APCost and skinData.APCost > 0 then
				...
				skinLabel.Size = UDim2.new(0.7, 0, 0, 30)
				...
				priceLabel.Size = UDim2.new(0.7, 0, 0, 20)
				...
				buyButton.Size = UDim2.new(0.3, -20, 1, -10)
				buyButton.Position = UDim2.new(0.7, 10, 0, 5)
				buyButton.Text = "Beli"
