...
local GameModeUpdateEvent = RemoteEvents:WaitForChild("GameModeUpdateEvent")
...
GameModeUpdateEvent.OnClientEvent:Connect(function(gameMode)
	if gameModeLabel then
		gameModeLabel.Text = string.format("Mode: %s", gameMode)
	end
end)
